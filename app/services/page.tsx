      ...
      <section className="bg-gradient-to-r from-blue-900 to-blue-700 py-24 text-white">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <p className="mt-6 max-w-3xl text-xl text-blue-100">
            Enterprise IT solutions designed to keep your business
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          {services.map((service) => (
            ...
            >
              ...
              <button className="mt-8 rounded-lg bg-blue-700 px-5 py-3 font-semibold text-white hover:bg-blue-800">
                Learn More
              </button>
            </div>
          ))}
